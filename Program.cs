...
namespace baitapOOP
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Name: " + employee1_135.getName());
            Console.WriteLine("Salary per day: " + employee1_135.calculateSalary());

            IEmployee employee2_135 = new FullTimeEmployee("Linh", 65000);
            Console.WriteLine("Name: " + employee2_135.getName());
            Console.WriteLine("Salary per day: " + employee2_135.calculateSalary());
            Console.ReadKey();
        }
    }
}
